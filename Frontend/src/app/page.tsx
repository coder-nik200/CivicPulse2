...
import HeroContent from "@/components/homeComponent/heroContent";
import CityStatus from "@/components/homeComponent/cityStatus";
import Intelligence from "@/components/homeComponent/intelligence";
          ...
          <div className="relative mx-auto max-w-[1240px] px-5 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-sm leading-7 text-slate-400">
                CivicFix creates a transparent chain of evidence from the moment
          ...
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:gap-16">
            <div>
              ...
              <p className="mt-5 max-w-md text-sm leading-7 text-slate-600">
                ...
                citizen reports, AI analysis, and issue history. AI helps teams
                see the signal, not replace human judgment.
              </p>
