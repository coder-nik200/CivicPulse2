  ...
  return (
    ...
    >
      <nav className="mx-auto flex h-[72px] max-w-[1280px] items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="relative grid h-10 w-10 place-items-center overflow-hidden rounded-xl bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 text-white shadow-lg shadow-emerald-500/20 transition duration-200 group-hover:scale-105">
          ...
          <div className="leading-none">
            <span className="block text-lg font-black tracking-tight sm:text-xl">
              Civic<span className="text-emerald-500">Fix</span>
            </span>

            <span
              className={`hidden pt-1 text-[8px] font-bold uppercase tracking-[0.18em] sm:block ${
